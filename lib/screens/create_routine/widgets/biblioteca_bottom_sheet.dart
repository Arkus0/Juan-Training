              ...
              child: Row(
                children: [
                  ...
                  PopupMenuButton<SortOption>(
                    ...
                    itemBuilder: (ctx) => [
                      _buildSortMenuItem(
                          SortOption.nameAsc, 'A → Z', Icons.sort_by_alpha,),
                      _buildSortMenuItem(
                          SortOption.nameDesc, 'Z → A', Icons.sort_by_alpha,),
                      _buildSortMenuItem(SortOption.muscleGroup, 'Por músculo',
                          Icons.fitness_center,),
                      _buildSortMenuItem(
                          SortOption.recentlyUsed, 'Favoritos', Icons.star,),
                    ],
                  ),
                        ...
                        itemBuilder: (ctx, idx) {
                          ...
                          return ActionChip(
                            avatar: Icon(Icons.add,
                                size: 16, color: Colors.redAccent[200],),
                            label: Text(
                              ex.name.length > 20
                ...
                builder: (context, exercises, _) {
                  ...
                  if (_selectedMuscle != 'Todos') {
                    ...
                    filtered = filtered.where((e) {
                      ...
                      final musclesLower =
                          e.muscles.map((m) => m.toLowerCase()).toList();
                      if (musclesLower.any((m) => m.contains(selectedLower))) {
                        return true;
                      }
                      if (musclesLower
                          .any((m) => synonyms.any((s) => m.contains(s)))) {
                        return true;
                      }
                  ...
                  return GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      final ex = filtered[index];
                      final isCustom =
                          ex.id < 0; // Ejercicios custom tienen ID negativo
                        ...
                        onLongPress: () {
                          ...
                          if (isCustom) {
                            ...
                            _showExercisePreview(
                                context, ex,); // 🆕 Preview con historial
                          }
                        },
                        child: Card(
                          color: Colors.grey[900],
                              ...
                              Padding(
                                ...
                                child: ElevatedButton(
                                  ...
                                  onPressed: () {
                                    ...
                                    widget.onAdd(ex);
                                    _addToRecent(
                                        ex,); // 🆕 Registrar en historial
                                    _generateSuggestions(
                                        ex,); // 🆕 Generar sugerencias
                                    _showAddedSnackbar(context, ex.name);
                                    setState(() {});
                                  },
